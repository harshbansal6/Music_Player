...
Original file is located at
    https://colab.research.google.com/drive/18r2pP_9MIaRIt3RXMEzxDWvdE18tZCPT
"""
...
#icon
#image_icon=PhotoImage(file="C://Users//hp//Downloads//logo.png")
#root.iconphoto(False,image_icon)

root.iconbitmap("C://Users//hp//Downloads//logo.ico")

Top=PhotoImage(file="C://Users//hp//Downloads//top.png")
Label(root,image=Top,bg="#0f1a2b").pack()

#logo
Logo=PhotoImage(file="C://Users//hp//Downloads//logo.png")
Label(root,image=Logo,bg="#0f1a2b").place(x=65,y=115)

#button
play_button=PhotoImage(file="C://Users//hp//Downloads//play.png")
Button(root,image=play_button,bg="#0f1a2b",bd=0,command=play_song).place(x=100,y=400)

stop_button=PhotoImage(file="C://Users//hp//Downloads//stop.png")
Button(root,image=stop_button,bg="#0f1a2b",bd=0,command=mixer.music.stop).place(x=30,y=500)

resume_button=PhotoImage(file="C://Users//hp//Downloads//resume.png")
Button(root,image=resume_button,bg="#0f1a2b",bd=0,command=mixer.music.unpause).place(x=115,y=500)

pause_button=PhotoImage(file="C://Users//hp//Downloads//pause.png")
...
#music
Menu=PhotoImage(file="C://Users//hp//Downloads//menu.png")
